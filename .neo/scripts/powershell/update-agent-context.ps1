...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.neo/templates/agent-file-template.md'
if (-not (Test-Path $TEMPLATE_FILE)) {
    $legacyTemplateFile = Join-Path $REPO_ROOT '.specify/templates/agent-file-template.md'
    if (Test-Path $legacyTemplateFile) {
        $TEMPLATE_FILE = $legacyTemplateFile
    }
}
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Ensure .neo/templates/agent-file-template.md exists (or legacy .specify/templates/agent-file-template.md).' 
        exit 1
    }
}
